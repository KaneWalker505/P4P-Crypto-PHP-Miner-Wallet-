...
PHP Crypto PHP-Miner-Wallet-Node
...
A custom made Decentralized Crypto currency created entirely in PHP
...
``` echo \
php -S localhost:8080 /PATHTOFOLDERWITHp4pnode.phpINSIDE
```
